...
const arrangementCheckTaskHandler = require(assets['/arrangement_check_task.js'].path);
...
exports.handler = async (context, event, callback) => {
  ...
  switch (CurrentTask) {
    ...
    case 'arrangement_check':
      await arrangementCheckTaskHandler(context, event, callback);
      break;
